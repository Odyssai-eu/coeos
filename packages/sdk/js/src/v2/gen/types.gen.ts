...
export type TaskRun = {
  taskId: string
  /**
   * The Orchestrator session that owns the Task File
   */
...
export type TaskFileTask = {
  /**
   * Task id from the Task File (e.g. T1)
   */
  id: string
  description: string
  /**
   * Subagent role the task is dispatched to (e.g. executor)
   */
  role: string
  status: "todo" | "doing" | "done" | "blocked"
  ...
  deps: Array<string>
  /**
   * Independent task, dispatchable as a background job
   */
  background: boolean
  /**
   * Part of the GO-approved set (hash match)
   */
  approved: boolean
}
...
export type TaskFileTask1 = {
  ...
  role: string
  status: "todo" | "doing" | "done" | "blocked"
  points?: number | "NaN" | "Infinity" | "-Infinity"
  /**
   * Task ids this task depends on
   */
  deps: Array<string>
...
export type EventTaskrunUpdated = {
  id: string
  type: "taskrun.updated"
  properties: {
    run: TaskRun1
...
export type EventTaskrunBlocked = {
  id: string
  type: "taskrun.blocked"
  properties: {
    run: TaskRun1
...
export type EventTaskfileUpdated = {
  id: string
  type: "taskfile.updated"
  properties: {
    planSessionID: string
...
export type AppAgentSaveErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type AppAgentSaveError = AppAgentSaveErrors[keyof AppAgentSaveErrors]

export type AppAgentSaveResponses = {
  /**
   * Path of the written agent file
   */
  200: {
    path: string
  }
...
export type AppAgentSaveResponse = AppAgentSaveResponses[keyof AppAgentSaveResponses]
