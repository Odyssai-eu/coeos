...
export class App extends HeyApiClient {
  ...
  /**
   * Generate an agent draft
   *
   * Generate an agent definition (identifier, description, system prompt) from a natural-language description.
   */
   ...
   * Save a custom agent
   *
   * Write an agent definition to .opencode/agent/<name>.md in the current worktree.
   */
  public agentSave<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<AppAgentSaveResponses, AppAgentSaveErrors, ThrowOnError>({
      url: "/agent/save",
      ...options,
      ...params,
      headers: {
   ...
   * Save a custom skill
   *
   * Write a SKILL.md to ~/.config/opencode/skill/<name>/SKILL.md.
   */
  public skillSave<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<AppSkillSaveResponses, AppSkillSaveErrors, ThrowOnError>({
      url: "/skill/save",
      ...options,
      ...params,
      headers: {
...
export class Mcp extends HeyApiClient {
   ...
   * Save MCP server
   *
   * Persist an MCP server to the user config (~/.config/opencode/opencode.json) and connect it live.
   */
  public save<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<McpSaveResponses, McpSaveErrors, ThrowOnError>({
      url: "/mcp/save",
      ...options,
      ...params,
      headers: {
   ...
   * Remove MCP server
   *
   * Disconnect an MCP server and remove it from the user config.
   */
  public remove<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
