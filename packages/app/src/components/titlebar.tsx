          ...
          {(_) => {
            ...
            return (
              ...
              >
                ...
                {/* coeos-code v2 : Mission Control (WU4) + Agents (WU5) */}
                <TooltipV2 placement="bottom" value={language.t("missionControl.title")} class="shrink-0">
                  <IconButtonV2
                    type="button"
                    variant="ghost-muted"
                    size="large"
                    ...
                    state={layout.route().type === "mission-control" ? "pressed" : undefined}
                    onClick={() => navigate("/mission-control")}
                    aria-label={language.t("missionControl.title")}
                    aria-pressed={layout.route().type === "mission-control"}
                  />
                </TooltipV2>
                <TooltipV2 placement="bottom" value={language.t("agentsPage.title")} class="shrink-0">
                  <IconButtonV2
                    type="button"
                    variant="ghost-muted"
                    size="large"
                    ...
                    state={layout.route().type === "agents" ? "pressed" : undefined}
                    onClick={() => navigate("/agents")}
                    aria-label={language.t("agentsPage.title")}
                    aria-pressed={layout.route().type === "agents"}
                  />
                </TooltipV2>
