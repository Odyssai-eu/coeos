export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par coeos-code",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans coeos-code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans coeos-code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans coeos-code.",
  ...
  "dialog.server.description": "Changez le serveur coeos-code auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'coeos-code ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe coeos-code",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'coeos-code ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "coeos-code inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur coeos-code dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour coeos-code",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'coeos-code sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si coeos-code suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'coeos-code.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'coeos-code",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'coeos-code.",
  ...
  "settings.memory.import.title": "Importer un vault",
  "settings.memory.import.description":
    "Merge un vault Obsidian (markdown) dans la mémoire de Némo. Les notes existantes sont conservées.",
  "settings.memory.import.button": "Importer…",
  "settings.memory.location.title": "Emplacement",
  "settings.memory.restart": "Redémarre Némo pour charger la mémoire.",
  "settings.memory.failed": "Import échoué",
  "settings.memory.desktopOnly": "La mémoire n'est disponible que sur l'app desktop.",
  "settings.memory.section.semantic": "Sémantique (optionnel)",
  "settings.memory.embed.hint":
    "Ajoute un retrieval sémantique au lexical. Endpoint /embeddings LOCAL (un serveur d'embeddings sur ton réseau) — la mémoire n'est jamais envoyée à un tiers. Vide = lexical seul.",
  "settings.memory.embed.url.label": "URL /embeddings",
  "settings.memory.embed.model.label": "Modèle",
  "settings.memory.embed.key.label": "Clé (option)",
  "settings.memory.embed.save": "Enregistrer",
  "settings.memory.embed.saved": "Embedder enregistré",
