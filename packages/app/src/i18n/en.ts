export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by coeos-code",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in coeos-code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in coeos-code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in coeos-code.",
  ...
  "dialog.server.description": "Switch which coeos-code server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "coeos-code",
  ...
  "wsl.onboarding.checkingOpencode": "Checking coeos-code...",
  "wsl.onboarding.checkingOpencodeIn": "Checking coeos-code in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating coeos-code...",
  "wsl.onboarding.updatingOpencodeIn": "Updating coeos-code in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update coeos-code in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update coeos-code",
  "wsl.onboarding.opencodeReadyIn": "coeos-code is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "coeos-code is ready.",
  "wsl.onboarding.installOpencodeIn": "Install coeos-code in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install coeos-code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "coeos-code not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before coeos-code can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "coeos-code could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen coeos-code.",
  ...
  "toast.update.description": "A new version of coeos-code ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the coeos-code team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, coeos-code does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "coeos-code includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the coeos-code server inside WSL on Windows.",
  ...
  "settings.general.row.sessionCanvas.title": "Session canvas",
  "settings.general.row.sessionCanvas.description":
    "Show a side panel with subagents, plan, and changed files for the current session",
  "settings.general.row.language.title": "Language",
  "settings.general.row.language.description": "Change the display language for coeos-code",
  ...
  "settings.general.row.appearance.description": "Customise how coeos-code looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether coeos-code follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how coeos-code is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when coeos-code launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of coeos-code.",
  ...
  "settings.memory.section.vault": "Vault",
  "settings.memory.import.title": "Import a vault",
  "settings.memory.import.description":
    "Merge an Obsidian vault (markdown) into Némo's memory. Existing notes are kept.",
  "settings.memory.import.button": "Import…",
  "settings.memory.location.title": "Location",
  "settings.memory.restart": "Restart Némo to load the memory.",
  "settings.memory.failed": "Import failed",
  "settings.memory.desktopOnly": "Memory is available on the desktop app only.",
  "settings.memory.section.semantic": "Semantic (optional)",
  "settings.memory.embed.hint":
    "Adds semantic retrieval on top of lexical. LOCAL /embeddings endpoint (an embeddings server on your network) — memory is never sent to a third party. Empty = lexical only.",
  "settings.memory.embed.url.label": "/embeddings URL",
  "settings.memory.embed.model.label": "Model",
  "settings.memory.embed.key.label": "Key (optional)",
  "settings.memory.embed.save": "Save",
  "settings.memory.embed.saved": "Embedder saved",
