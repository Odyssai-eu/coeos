...
const api: ElectronAPI = {
  ...
  importMemoryVault: (sourcePath) => ipcRenderer.invoke("import-memory-vault", sourcePath),
  getMemoryVaultPath: () => ipcRenderer.invoke("get-memory-vault-path"),
  getMemoryEmbedConfig: () => ipcRenderer.invoke("get-memory-embed-config"),
  setMemoryEmbedConfig: (cfg) => ipcRenderer.invoke("set-memory-embed-config", cfg),
  ...
  getYolo: () => ipcRenderer.invoke("get-yolo"),
  setYolo: (enabled) => ipcRenderer.invoke("set-yolo", enabled),
  getLocalEngine: () => ipcRenderer.invoke("get-local-engine"),
  setLocalEngine: (url, token) => ipcRenderer.invoke("set-local-engine", url, token),
  getExtraProviders: () => ipcRenderer.invoke("get-extra-providers"),
  setExtraProviders: (raw) => ipcRenderer.invoke("set-extra-providers", raw),
  getTriageModel: () => ipcRenderer.invoke("get-triage-model"),
  setTriageModel: (id) => ipcRenderer.invoke("set-triage-model", id),
  listDeclaredModels: () => ipcRenderer.invoke("list-declared-models"),
  getRouterName: () => ipcRenderer.invoke("get-router-name"),
  setRouterName: (name) => ipcRenderer.invoke("set-router-name", name),
  getResolvedEngine: () => ipcRenderer.invoke("get-resolved-engine"),
  getEngines: () => ipcRenderer.invoke("get-engines"),
  setEngines: (list) => ipcRenderer.invoke("set-engines", list),
  testEngine: (baseURL, apiKey) => ipcRenderer.invoke("test-engine", baseURL, apiKey),
  getPlanModel: () => ipcRenderer.invoke("get-plan-model"),
  setPlanModel: (modelID) => ipcRenderer.invoke("set-plan-model", modelID),
  getBuildModel: () => ipcRenderer.invoke("get-build-model"),
  setBuildModel: (modelID) => ipcRenderer.invoke("set-build-model", modelID),
