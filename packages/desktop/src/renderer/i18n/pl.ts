export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji coeos-code",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} coeos-code. Czy chcesz ją zainstalować i uruchomić ponownie?",
