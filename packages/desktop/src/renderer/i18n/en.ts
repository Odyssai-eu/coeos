export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of coeos-code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of coeos-code has been downloaded, would you like to install it and relaunch?",
