export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'coeos-code",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'coeos-code a été téléchargée. Voulez-vous l'installer et redémarrer ?",
