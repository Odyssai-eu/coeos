export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju coeos-code-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} coeos-code-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
