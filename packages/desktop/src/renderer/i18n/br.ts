export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do coeos-code",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do coeos-code foi baixada. Você gostaria de instalá-la e reiniciar?",
