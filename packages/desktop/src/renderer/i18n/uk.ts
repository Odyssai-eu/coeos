export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію coeos-code",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} coeos-code завантажено. Бажаєте встановити її та перезапустити?",
