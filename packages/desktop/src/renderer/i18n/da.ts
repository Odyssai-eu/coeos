export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af coeos-code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af coeos-code er blevet downloadet. Vil du installere den og genstarte?",
