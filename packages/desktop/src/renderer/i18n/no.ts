export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av coeos-code",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av coeos-code er lastet ned. Vil du installere den og starte på nytt?",
