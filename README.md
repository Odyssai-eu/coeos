...
| **Code** | The coding mode: an orchestrator that plans into a task file, a three-mandate decision panel (direct / alternative / sceptic), an adversarial plan grill by a different model family, executor, reviewer, debugger and explore agents. |
